...
def testSmartPlug():
    plug = SmartPlug(45)
    plug.toggleSwitch()
    print("Status:",plug.getStatus())
    print("Consumption Rate:",plug.getConsumtionRate())
    plug.setConsumptionRate(75)
    print("New Consumption Rate:",plug.getConsumtionRate())
    print(plug)
...
def testDevice():
    ...
    device.toggleSwitch()
    print("Switch status: ", device.getStatus())
